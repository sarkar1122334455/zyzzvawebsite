...
export default function GlimpsesPage() {
    ...
    return (
        <div
            ...
            onMouseEnter={() => {
                // Optional: Pause on hover if desired, or keep it running?
                // User said "always be kept on", implying maybe don't stop?
                // But usually interaction requires pausing. 
                // I will keep the pause-on-hover logic as it's standard UX, 
                // but rely on "startAutoPlay" for resume.
                if (autoPlayRef.current) {
                    clearInterval(autoPlayRef.current);
                    autoPlayRef.current = null;
                }
        ...
        >
            ...
            <div className={styles.titleContainer}>
                <img src="/glimpses.png" alt="Glimpses" className={styles.pageTitleImage} />
            </div>
